            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url(); ?>admin/advertising">Advertising</a></li>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <form id="frm-advertising-update">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Título</label>
                                                    <input type="text" name="edtTitle" value="<?php echo $a->current()->ads_title; ?>" class="form-control" maxlength="200" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>De:</label>
                                                <input type="text" name="edtDateInitial" class="form-control input-date" maxlength="20" value="<?php echo $a->current()->ads_date_initial; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Até:</label>
                                                <input type="text" name="edtDateFinish" class="form-control input-date" maxlength="20" value="<?php echo $a->current()->ads_date_finish; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <h4>Mídia</h4>
