                                    ...
                                    <form id="frm-classified-insert">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Nome</label>
                                                <input type="text" name="edtName" class="form-control" maxlength="200"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="edtAddress" class="form-control" maxlength="200"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <select name="cmbCategory" class="form-control select2" id="cmd-category-classified"
                                                    ...
                                                    <?php
                                                                ...
                                                                while ($c->valid()) :
                                                                    ?>
                                                    <option value="<?php echo $c->current()->cla_cat_item; ?>">
                                                        <?php echo $c->current()->cla_cat_name_item; ?>
                                                    </option>
                                                    <?php
                                                                    $c->next();
                                                                endwhile;
