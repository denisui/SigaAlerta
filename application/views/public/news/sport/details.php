...
<head>
	...
	<meta property='og:url' content="<?php echo base_url(); ?>news/sport/details/<?php echo $n->current()->id; ?>/<?php echo $this->general->normalizeURL($n->current()->new_title); ?>" />
	...
	<!--title-->
	<title>Sigalerta .: Notícias | Esporte | <?php echo $n->current()->new_title; ?> :.</title>
