...
<head>
	...
	<meta property='og:url' content="<?php echo base_url(); ?>news/fashion" />
	...
	<!--title-->
	<title>Sigalerta .: Notícicas | Moda :.</title>
									...
									<div class="post medium-post">
										<div class="entry-header">
											<div class="entry-thumbnail">
												<a href="<?php echo base_url(); ?>news/fashion/details/<?php echo $n->current()->id; ?>/<?php echo $this->general->normalizeURL($n->current()->new_title); ?>">
										...
										<div class="post-content">
											...
											<h2 class="entry-title">
												<a href="<?php echo base_url(); ?>news/fashion/details/<?php echo $n->current()->id; ?>/<?php echo $this->general->normalizeURL($n->current()->new_title); ?>"><?php echo $n->current()->new_title ?></a>
											</h2>
										</div>
									</div>
									<!--/post-->
