...
<head>
	...
	<meta property='og:url' content="<?php echo base_url(); ?>news/entertainment/details/<?php echo $n->current()->id; ?>/<?php echo $this->general->normalizeURL($n->current()->new_title); ?>" />
	...
	<!--title-->
	<title>Sigalerta .: Notícias | Entretenimento | <?php echo $n->current()->new_title; ?> :.</title>
							...
							<div class="entry-title entry-title-custom">
								...
								<div class="entry-meta">
									<ul class="list-inline">
										<li class="f-size-16 f-c-white">Entretenimento</li>
										<li>|</li>										
										...
										<div class="row">
											...
											<div class="col-sm-4" data-mh="group-name">
												<div class="post medium-post">
													<div class="entry-header">
														<div class="entry-thumbnail">
														<a href="<?php echo base_url(); ?>news/local/details/<?php echo $n->current()->id; ?>/<?php echo $this->general->normalizeURL($n->current()->new_title); ?>"><img class="img-responsive" src="<?php echo base_url(); ?>assets/public/images/news/<?php echo $n->current()->new_img; ?>" alt="" style="width: 100%; height: 150px" /></a>
														</div>
													</div>
													<div class="post-content">
														<div class="entry-meta">
