...
<head>
	...
	<meta property='og:url' content="<?php echo base_url(); ?>news/eua/details/<?php echo $n->current()->id; ?>/<?php echo $this->general->normalizeURL($n->current()->new_title); ?>" />
	...
	<!--title-->
	<title>Sigalerta .: Notícias | Estados Unidos | <?php echo $n->current()->new_title; ?> :.</title>
							...
							<div class="entry-title entry-title-custom">
								...
								<div class="entry-meta">
									<ul class="list-inline">
										<li class="f-size-16 f-c-white">Estados Unidos</li>
										<li>|</li>										
