...
<head>
	...
	<meta property='og:url' content="<?php echo base_url(); ?>news/technology/details/<?php echo $n->current()->id; ?>/<?php echo $this->general->normalizeURL($n->current()->new_title); ?>" />
	...
	<!--title-->
	<title>Sigalerta .: Notícias | Tecnologia | <?php echo $n->current()->new_title; ?> :.</title>
							...
							<div class="entry-title entry-title-custom">
								...
								<div class="entry-meta">
									<ul class="list-inline">
										<li class="f-size-16 f-c-white">Tecnologia</li>
										<li>|</li>										
