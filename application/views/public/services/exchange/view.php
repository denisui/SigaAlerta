...
<head>
	...
	<!--title-->
	<title>Sigalerta .: Serviços | Envio de Dinheiro para o Brasil :.</title>
			...
			<div class="page-breadcrumbs page-breadcrumbs-custom">
				...
				<div class="world-nav cat-menu">
					<ul class="list-inline">
						<li class="active">
							<a href="#">Envio de Dinheiro para o Brasil</a>
						</li>
					</ul>
				</div>
			</div>
									...
									<div class="post medium-post">
										<div class="entry-header">
											<div class="entry-thumbnail">
												<a href="<?php echo base_url(); ?>services/exchange/details/<?php echo $n->current()->id_service_service; ?>/<?php echo $this->general->normalizeURL($n->current()->serv_name); ?>">
