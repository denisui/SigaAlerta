...
<head>
	...
	<!--title-->
	<title>Sigalerta .: Serviços | Restaurantes Brasileiros :.</title>
			...
			<div class="page-breadcrumbs page-breadcrumbs-custom">
				...
				<div class="world-nav cat-menu">
					<ul class="list-inline">
						<li class="active">
							<a href="#">Restaurantes Brasileiros</a>
						</li>
					</ul>
				</div>
			</div>
									...
									<div class="post medium-post">
										<div class="entry-header">
											<div class="entry-thumbnail">
												<a href="<?php echo base_url(); ?>services/brasilianrestaurants/details/<?php echo $n->current()->id_service; ?>/<?php echo $this->general->normalizeURL($n->current()->serv_name); ?>">
