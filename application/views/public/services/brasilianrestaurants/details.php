...
<head>
	...
	<meta property='og:description' content='<?php echo $s->current()->serv_name; ?>' />
	<meta property='og:url' content="<?php echo base_url(); ?>services/brasilianrestaurants/details/<?php echo $s->current()->id; ?>/<?php echo $this->general->normalizeURL($s->current()->serv_name); ?>" />
	<meta property='og:image' content="<?php echo base_url(); ?>assets/public/images/services/<?php echo $s->current()->serv_img; ?>" />
	...
	<!--title-->
	<title>Sigalerta .: Serviços | Restaurantes Brasileiros | <?php echo $s->current()->serv_name; ?> :.</title>
							...
							<div class="row">
								<div class="col-sm-12">
											...
											<div class="post">
												...
												<div class="post-content">								
													<div class="entry-content">
														<?php echo $s->current()->serv_description; ?>
									...
									<div class="section gap-50">
										<h1 class="section-title">Serviços Relacionados</h1>
										<div class="row">
											<?php	
                                                if (empty($older_news)) :
                                            ?>
											...
											<div class="col-sm-4" data-mh="group-name">
												<div class="post medium-post">
													<div class="entry-header">
														<div class="entry-thumbnail">
															<a href="<?php echo base_url(); ?>services/brasilianrestaurants/details/<?php echo $s->current()->id; ?>/<?php echo $this->general->normalizeURL($s->current()->serv_name); ?>">
																<img class="img-responsive h-150" src="<?php echo base_url(); ?>assets/public/images/services/<?php echo $s->current()->serv_img; ?>" alt="" />
															</a>
														</div>
													</div>
													<div class="post-content">
														<div class="entry-meta">
															<ul class="list-inline">
																<li class="publish-date">
																	...
																	<?php 
                                                                        $date = explode('-', $s->current()->new_date_time);
														...
														<h2 class="entry-title">
															<a href="<?php echo base_url(); ?>services/brasilianrestaurants/details/<?php echo $s->current()->id; ?>/<?php echo $this->general->normalizeURL($s->current()->new_title); ?>">
																<?php echo $s->current()->new_title ?>
															</a>
														</h2>
													</div>
												</div>
