...
<head>
	...
	<meta property='og:url' content="<?php echo base_url(); ?>services/agency/details/<?php echo $s->current()->id; ?>/<?php echo $this->general->normalizeURL($s->current()->serv_name); ?>" />
	...
	<!--title-->
	<title>Sigalerta .: Serviços | Agência de Seguros | <?php echo $s->current()->serv_name; ?> :.</title>
										...
										<div class="row">
											...
											<div class="col-sm-4" data-mh="group-name">
												<div class="post medium-post">
													<div class="entry-header">
														<div class="entry-thumbnail">
															<a href="<?php echo base_url(); ?>services/agency/details/<?php echo $s->current()->id; ?>/<?php echo $this->general->normalizeURL($s->current()->serv_name); ?>">
													...
													<div class="post-content">
														...
														<h2 class="entry-title">
															<a href="<?php echo base_url(); ?>services/agency/details/<?php echo $s->current()->id; ?>/<?php echo $this->general->normalizeURL($s->current()->new_title); ?>">
