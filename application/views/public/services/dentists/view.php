...
<head>
	...
	<!--title-->
	<title>Sigalerta .: Serviços | Dentistas :.</title>
									...
									<div class="post medium-post">
										<div class="entry-header">
											<div class="entry-thumbnail">
												<a href="<?php echo base_url(); ?>services/dentists/details/<?php echo $n->current()->id_service; ?>/<?php echo $this->general->normalizeURL($n->current()->serv_name); ?>">
