...
<head>
	...
	<meta property='og:url' content="<?php echo base_url(); ?>forhome/furniture/details/<?php echo $s->current()->id; ?>/<?php echo $this->general->normalizeURL($s->current()->fh_name); ?>" />
	...
	<!--title-->
	<title>Sigalerta .: Para sua Casa | Móveis | <?php echo $s->current()->fh_name; ?> :.</title>
	<?php
	$s->next();
	endwhile;
	?>
