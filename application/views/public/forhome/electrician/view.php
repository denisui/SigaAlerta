...
<head>
	...
	<!--title-->
	<title>Sigalerta .: Para sua Casa | Eletrecista  :.</title>
									...
									<div class="post medium-post">
										<div class="entry-header">
											<div class="entry-thumbnail">
												<a href="<?php echo base_url(); ?>forhome/electrician/details/<?php echo $n->current()->id; ?>/<?php echo $this->general->normalizeURL($n->current()->fh_name); ?>">
