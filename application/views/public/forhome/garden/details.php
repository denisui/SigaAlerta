...
<head>
	...
	<meta property='og:url' content="<?php echo base_url(); ?>forhome/garden/details/<?php echo $s->current()->id; ?>/<?php echo $this->general->normalizeURL($s->current()->fh_name); ?>" />
	...
	<!--title-->
	<title>Sigalerta .: Para sua Casa | Jardinagem e Paisagismo | <?php echo $s->current()->fh_name; ?> :.</title>
	<?php
	$s->next();
	endwhile;
	?>
											...
											<div class="post">
												...
												<div class="entry-header">
													<div class="entry-thumbnail">
														<img class="img-responsive" src="<?php echo base_url(); ?>assets/public/images/forhome/<?php echo $s->current()->fh_img; ?>" alt="" />
													</div>
												</div>
												<div class="post-content">								
													<div class="entry-content">
														<h2><?php echo $s->current()->fh_name; ?></h2>
									...
									<div class="section gap-50">
										...
										<div class="row">
											<?php	
                                                if (empty($older_news)) :
                                            ?>
											<h4 class="text-center">Nenhum conteúdo encontrado</h4>
											<?php
                                                else:
											...
											<div class="col-sm-4" data-mh="group-name">
												<div class="post medium-post">
													<div class="entry-header">
														<div class="entry-thumbnail">
															<a href="<?php echo base_url(); ?>forhome/garden/details/<?php echo $s->current()->id; ?>/<?php echo $this->general->normalizeURL($s->current()->fh_name); ?>">
													...
													<div class="post-content">														
														<h2 class="entry-title">
															<a href="<?php echo base_url(); ?>forhome/garden/details/<?php echo $s->current()->id; ?>/<?php echo $this->general->normalizeURL($s->current()->fh_title); ?>">
																<?php echo $s->current()->fh_title; ?>
															</a>
														</h2>
													</div>
												</div>
