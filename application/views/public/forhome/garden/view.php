...
<head>
	...
	<!--title-->
	<title>Sigalerta .: Para sua Casa | Construção  :.</title>
			...
			<div class="page-breadcrumbs page-breadcrumbs-custom">
				...
				<div class="world-nav cat-menu">
					<ul class="list-inline">
						<li class="active">
							<a href="#">Jardinagem e Paisagismo</a>
						</li>
					</ul>
				</div>
			</div>
									...
									<div class="post medium-post">
										<div class="entry-header">
											<div class="entry-thumbnail">
												<a href="<?php echo base_url(); ?>forhome/garden/details/<?php echo $n->current()->id; ?>/<?php echo $this->general->normalizeURL($n->current()->fh_name); ?>">
													<img class="img-responsive h-150" src="<?php echo base_url(); ?>assets/public/images/forhome/<?php echo $n->current()->fh_img ?>" alt="" />
												</a>
											</div>
										</div>
