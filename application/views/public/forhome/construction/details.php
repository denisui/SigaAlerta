...
<head>
	...
	<meta property='og:url' content="<?php echo base_url(); ?>forhome/construction/details/<?php echo $s->current()->id; ?>/<?php echo $this->general->normalizeURL($s->current()->fh_name); ?>" />
	...
	<!--title-->
	<title>Sigalerta .: Para sua Casa | Construção | <?php echo $s->current()->fh_name; ?> :.</title>
	<?php
	$s->next();
	endwhile;
	?>
										...
										<div class="row">
											...
											<div class="col-sm-4" data-mh="group-name">
												<div class="post medium-post">
													<div class="entry-header">
														<div class="entry-thumbnail">
															<a href="<?php echo base_url(); ?>forhome/construction/details/<?php echo $s->current()->id; ?>/<?php echo $this->general->normalizeURL($s->current()->fh_name); ?>">
