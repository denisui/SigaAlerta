...
<head>
	...
	<meta property='og:url' content="<?php echo base_url(); ?>classified/employment" />
	...
	<!--title-->
	<title>Sigalerta .: Classificados | Empregos :.</title>
									...
									<div class="post medium-post">
										<div class="entry-header">
											<div class="entry-thumbnail">
												<a href="<?php echo base_url(); ?>classified/employment/details/<?php echo $d->current()->id; ?>/<?php echo $this->general->normalizeURL($d->current()->cla_name); ?>">
										...
										<div class="post-content">
											...
											<h2 class="entry-title">
												<a href="<?php echo base_url(); ?>classified/employment/details/<?php echo $d->current()->id; ?>/<?php echo $this->general->normalizeURL($d->current()->cla_name); ?>"><?php echo $d->current()->cla_name; ?></a>
											</h2>
										</div>
									</div>
									<!--/post-->
