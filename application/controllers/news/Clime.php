...
class Clime extends CI_Controller {
    ...
    public function index() {
         ...
         */
        $config["base_url"] = base_url() . 'news/clime/p';
        ...
        $data['news'] = $this->Model_News->getNewsCategory('Clima','id', 'desc', $config['per_page'], $offset);
        $data['columnists'] = $this->Model_Columnists->getColumnists('id', 'desc', '1', '0');
        $data['adsW1140H87'] = $this->Model_Advertising->getByPage('Clima', 'id', 'asc', '1', '0');
        $data['adsW263H293'] = $this->Model_Advertising->getByPage('Clima', 'id', 'asc', '1', '1');
        $data['adsW263H293_2'] = $this->Model_Advertising->getByPage('Clima', 'id', 'asc', '1', '2');
        $this->load->view('public/news/clime/view', $data);
    }
    ...
    public function details($id = NULL) {
        if (empty($id)) {            
            ...
            $data['adsW1140H87'] = $this->Model_Advertising->getByPage('Clima', 'id', 'asc', '1', '0');
            $data['adsW263H293'] = $this->Model_Advertising->getByPage('Clima', 'id', 'asc', '1', '1');
            $this->load->view('public/news/clime/details', $data);
        }
